...
appSocialNetwork.controller('controllerNewsFeed',
    ['$scope', '$location', '$route', 'userData', 'postData', 'friendsData', 'authenticationData', 'notificationService',
        function ($scope, $location, $route, userData, postData, friendsData, authenticationData, notificationService) {
